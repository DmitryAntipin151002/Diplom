...
import '../styles/AuthPage.css';  // Здесь ты подключишь стили
        ...
        <div className="container">
            <div className="frame">
                ...
                <form className="form-signup">
                    ...
                    <a onClick={() => setChecked(!checked)} className="btn-signup">Sign Up</a>
                </form>
            ...
            <div>
                ...
                <a className="btn-goback" onClick={() => window.history.go()}>Go back</a>
            </div>

            <a id="refresh" onClick={() => window.history.go()}>
                <svg className="refreshicon" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="25px" height="25px" viewBox="0 0 322.447 322.447">
