...
public class ProfileController {
    ...
    @GetMapping
    public ResponseEntity<UserProfileResponse> getProfile(@RequestParam String email) throws AuthException {
    ...
    @PostMapping("/create")
    public ResponseEntity<UserProfileResponse> createProfile(@RequestParam String email, @Valid @RequestBody ProfileUpdateRequest request) throws AuthException {
        Users user = userService.getAuthenticatedUser(email);
